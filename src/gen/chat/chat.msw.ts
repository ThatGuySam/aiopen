    ...
    return faker.helpers.arrayElement([
        {
            ...
            choices: Array.from({
                ...
                message: {
                    ...
                    refusal: faker.helpers.arrayElement([
                        faker.string.alpha(20),
                        null,
                    ]),
                    tool_calls: faker.helpers.arrayElement([
                        Array.from({
                            ...
                            function: {
                                ...
                                arguments: faker.string.alpha(20),
                            },
                        })),
                        undefined,
                    ]),
                    role: faker.helpers.arrayElement(['assistant'] as const),
                    function_call: faker.helpers.arrayElement([
                        {
                            arguments: faker.string.alpha(20),
                            name: faker.string.alpha(20),
                        },
                    ...
                    audio: faker.helpers.arrayElement([
                        {
                            id: faker.string.alpha(20),
                            ...
                            transcript: faker.string.alpha(20),
                        },
                        undefined,
                    ]),
                },
        ...
        },
        {
            ...
            choices: Array.from({
                ...
                logprobs: faker.helpers.arrayElement([
                    {
                        content: Array.from({
                            length: faker.number.int({
                                min: 1,
            ...
            object: faker.helpers.arrayElement(['chat.completion.chunk'] as const),
            usage: faker.helpers.arrayElement([
                {
                    completion_tokens: faker.number.int({
                        min: undefined,
...
export function getChatMock() {
    return [getCreateChatCompletionMockHandler()]
}
