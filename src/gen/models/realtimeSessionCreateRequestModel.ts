 ...
 */
export type RealtimeSessionCreateRequestModel = typeof RealtimeSessionCreateRequestModel[keyof typeof RealtimeSessionCreateRequestModel]

// eslint-disable-next-line ts/no-redeclare
export const RealtimeSessionCreateRequestModel = {
